...
public final class DeleteRelationshipGroupMemberRequest extends
    ...
    public static Builder newBuilder(
            DeleteRelationshipGroupMemberRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<DeleteRelationshipGroupMemberRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<DeleteRelationshipGroupMemberRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (DeleteRelationshipGroupMemberRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
