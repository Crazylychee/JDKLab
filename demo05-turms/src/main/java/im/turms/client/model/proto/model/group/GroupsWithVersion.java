...
public final class GroupsWithVersion extends
    ...
    private com.google.protobuf.Internal.ProtobufList<Group> groups_;
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public java.util.List<? extends GroupOrBuilder> getGroupsOrBuilderList() {
        return groups_;
    }
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    public GroupOrBuilder getGroupsOrBuilder(int index) {
        return groups_.get(index);
    }

    private void ensureGroupsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<Group> tmp =
                groups_;
        if (!tmp.isModifiable()) {
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    private void setGroups(int index, Group value) {
        value.getClass();
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    private void addGroups(Group value) {
        value.getClass();
        ensureGroupsIsMutable();
        groups_.add(value);
    }
     ...
     * <code>repeated .im.turms.proto.Group groups = 1;</code>
     */
    private void addGroups(int index, Group value) {
        value.getClass();
        ensureGroupsIsMutable();
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<GroupsWithVersion, Builder>
            implements
         ...
         * <code>repeated .im.turms.proto.Group groups = 1;</code>
         */
        public Builder setGroups(int index, Group value) {
            copyOnWrite();
         ...
         * <code>repeated .im.turms.proto.Group groups = 1;</code>
         */
        public Builder addGroups(int index, Group value) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<GroupsWithVersion> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (GroupsWithVersion.class) {
                        parser = PARSER;
                        if (parser == null) {
