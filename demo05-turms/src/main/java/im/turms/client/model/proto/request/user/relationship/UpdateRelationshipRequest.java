...
public final class UpdateRelationshipRequest extends
    ...
    public static Builder newBuilder(
            UpdateRelationshipRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateRelationshipRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateRelationshipRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateRelationshipRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
