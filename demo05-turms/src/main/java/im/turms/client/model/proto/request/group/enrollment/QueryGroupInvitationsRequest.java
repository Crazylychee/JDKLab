...
public final class QueryGroupInvitationsRequest extends
    ...
    public static Builder newBuilder(
            QueryGroupInvitationsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryGroupInvitationsRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryGroupInvitationsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryGroupInvitationsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
