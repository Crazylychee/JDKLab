...
public interface CreateSessionRequestOrBuilder extends
     ...
     * <code>map&lt;string, string&gt; device_details = 6;</code>
     */
    boolean containsDeviceDetails(String key);

    /**
     * Use {@link #getDeviceDetailsMap()} instead.
     */
    @Deprecated
    java.util.Map<String, String> getDeviceDetails();

    /**
     * <code>map&lt;string, string&gt; device_details = 6;</code>
     */
    java.util.Map<String, String> getDeviceDetailsMap();
    ...
    String getDeviceDetailsOrThrow(String key);
