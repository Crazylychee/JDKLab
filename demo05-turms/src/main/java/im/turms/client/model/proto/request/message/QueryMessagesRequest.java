...
public final class QueryMessagesRequest extends
     ...
     */
    @Override
    public java.util.List<Long> getFromIdsList() {
        return fromIds_;
    }
     ...
     */
    private void addAllFromIds(Iterable<? extends Long> values) {
        ensureFromIdsIsMutable();
    ...
    public static Builder newBuilder(
            QueryMessagesRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryMessagesRequest, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllFromIds(Iterable<? extends Long> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryMessagesRequest> parser =
                        PARSER;
                if (parser == null) {
