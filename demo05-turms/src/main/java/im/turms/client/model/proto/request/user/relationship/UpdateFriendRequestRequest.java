...
public final class UpdateFriendRequestRequest extends
    ...
    public static Builder newBuilder(
            UpdateFriendRequestRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateFriendRequestRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateFriendRequestRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateFriendRequestRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
