...
public final class QueryRelatedUserIdsRequest extends
     ...
     */
    @Override
    public java.util.List<Integer> getGroupIndexesList() {
     ...
     */
    private void addAllGroupIndexes(Iterable<? extends Integer> values) {
        ensureGroupIndexesIsMutable();
    ...
    public static QueryRelatedUserIdsRequest parseFrom(
    ...
    public static QueryRelatedUserIdsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            QueryRelatedUserIdsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryRelatedUserIdsRequest, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllGroupIndexes(Iterable<? extends Integer> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryRelatedUserIdsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryRelatedUserIdsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final QueryRelatedUserIdsRequest DEFAULT_INSTANCE;
    static {
    ...
    public static QueryRelatedUserIdsRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
