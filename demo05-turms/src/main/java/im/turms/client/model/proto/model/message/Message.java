...
public final class Message
    ...
    private com.google.protobuf.Internal.ProtobufList<MessageReactionGroup> reactionGroups_;

    /**
     * <code>repeated .im.turms.proto.MessageReactionGroup reaction_groups = 12;</code>
     */
    @Override
    public java.util.List<MessageReactionGroup> getReactionGroupsList() {
     ...
     * <code>repeated .im.turms.proto.MessageReactionGroup reaction_groups = 12;</code>
     */
    public java.util.List<? extends MessageReactionGroupOrBuilder> getReactionGroupsOrBuilderList() {
        return reactionGroups_;
    }
     ...
     */
    @Override
    public MessageReactionGroup getReactionGroups(
            int index) {
     ...
     * <code>repeated .im.turms.proto.MessageReactionGroup reaction_groups = 12;</code>
     */
    public MessageReactionGroupOrBuilder getReactionGroupsOrBuilder(
            int index) {
        return reactionGroups_.get(index);
    }

    private void ensureReactionGroupsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<MessageReactionGroup> tmp =
                reactionGroups_;
        if (!tmp.isModifiable()) {
    ...
    private void addAllReactionGroups(
            Iterable<? extends MessageReactionGroup> values) {
        ensureReactionGroupsIsMutable();
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<Message, Builder>
            implements
        ...
        public Builder setReactionGroups(
                int index,
                MessageReactionGroup.Builder builderForValue) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<Message> parser =
                        PARSER;
                if (parser == null) {
