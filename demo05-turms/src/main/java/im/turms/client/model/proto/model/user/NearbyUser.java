...
public final class NearbyUser
     ...
     * <code>optional .im.turms.proto.UserInfo info = 3;</code>
     */
    private void setInfo(UserInfo value) {
        value.getClass();
        info_ = value;
    ...
    private void mergeInfo(UserInfo value) {
        value.getClass();
        if (info_ != null
                && info_ != UserInfo.getDefaultInstance()) {
            info_ = UserInfo.newBuilder(info_)
                    .mergeFrom(value)
                    .buildPartial();
        } else {
            info_ = value;
    ...
    public UserLocation getLocation() {
        return location_ == null
                ? UserLocation.getDefaultInstance()
                : location_;
    }
     ...
     * <code>optional .im.turms.proto.UserLocation location = 5;</code>
     */
    private void setLocation(UserLocation value) {
        value.getClass();
        location_ = value;
     ...
     */
    @SuppressWarnings({"ReferenceEquality"})
    private void mergeLocation(UserLocation value) {
        value.getClass();
        if (location_ != null
                && location_ != UserLocation
                        .getDefaultInstance()) {
            location_ = UserLocation.newBuilder(location_)
                    .mergeFrom(value)
                    .buildPartial();
        } else {
            location_ = value;
    ...
    public static NearbyUser parseFrom(
    ...
    public static NearbyUser parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
    }
    ...
    public static NearbyUser parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(NearbyUser prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<NearbyUser, Builder>
            implements
         ...
         * <code>optional .im.turms.proto.UserInfo info = 3;</code>
         */
        public Builder setInfo(UserInfo value) {
            copyOnWrite();
         ...
         * <code>optional .im.turms.proto.UserInfo info = 3;</code>
         */
        public Builder mergeInfo(UserInfo value) {
            copyOnWrite();
         ...
         * <code>optional .im.turms.proto.UserLocation location = 5;</code>
         */
        public Builder setLocation(UserLocation value) {
            copyOnWrite();
        ...
        public Builder setLocation(
                UserLocation.Builder builderForValue) {
            copyOnWrite();
         ...
         * <code>optional .im.turms.proto.UserLocation location = 5;</code>
         */
        public Builder mergeLocation(UserLocation value) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<NearbyUser> parser =
                        PARSER;
                if (parser == null) {
