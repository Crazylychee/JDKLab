...
public final class UpdateMeetingInvitationRequest extends
    ...
    public static UpdateMeetingInvitationRequest parseFrom(
    ...
    public static UpdateMeetingInvitationRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            UpdateMeetingInvitationRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateMeetingInvitationRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new UpdateMeetingInvitationRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateMeetingInvitationRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateMeetingInvitationRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final UpdateMeetingInvitationRequest DEFAULT_INSTANCE;
    static {
    ...
    public static UpdateMeetingInvitationRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
