...
public final class QueryUserSettingsRequest extends
    ...
    public static QueryUserSettingsRequest parseFrom(
    ...
    public static QueryUserSettingsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            QueryUserSettingsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryUserSettingsRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new QueryUserSettingsRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryUserSettingsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryUserSettingsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final QueryUserSettingsRequest DEFAULT_INSTANCE;
    static {
    ...
    public static QueryUserSettingsRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
