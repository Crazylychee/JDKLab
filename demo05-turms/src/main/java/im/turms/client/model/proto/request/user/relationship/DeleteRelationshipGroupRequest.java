...
public final class DeleteRelationshipGroupRequest extends
    ...
    public static Builder newBuilder(
            DeleteRelationshipGroupRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<DeleteRelationshipGroupRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<DeleteRelationshipGroupRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (DeleteRelationshipGroupRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
