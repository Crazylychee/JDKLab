...
public final class QueryGroupsRequest extends
    ...
    public static QueryGroupsRequest parseFrom(
    ...
    public static QueryGroupsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryGroupsRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryGroupsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryGroupsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final QueryGroupsRequest DEFAULT_INSTANCE;
    static {
