...
public final class UpdateMessageRequest extends
    ...
    public static Builder newBuilder(
            UpdateMessageRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateMessageRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateMessageRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateMessageRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
