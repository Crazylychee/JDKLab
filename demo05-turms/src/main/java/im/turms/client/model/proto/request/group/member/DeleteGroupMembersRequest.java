...
public final class DeleteGroupMembersRequest extends
     ...
     */
    @Override
    public java.util.List<Long> getMemberIdsList() {
        return memberIds_;
    }
     ...
     */
    private void addAllMemberIds(Iterable<? extends Long> values) {
        ensureMemberIdsIsMutable();
    ...
    public static DeleteGroupMembersRequest parseFrom(
    ...
    public static DeleteGroupMembersRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            DeleteGroupMembersRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<DeleteGroupMembersRequest, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllMemberIds(Iterable<? extends Long> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<DeleteGroupMembersRequest> parser =
                        PARSER;
                if (parser == null) {
