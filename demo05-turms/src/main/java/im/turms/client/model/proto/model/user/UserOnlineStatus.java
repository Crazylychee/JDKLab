...
public final class UserOnlineStatus
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<Integer, im.turms.client.model.proto.constant.DeviceType> deviceTypes_converter_ =
            from -> {
     ...
     */
    @Override
    public java.util.List<Integer> getDeviceTypesValueList() {
        return deviceTypes_;
    }
    ...
    private void addAllDeviceTypes(
            Iterable<? extends im.turms.client.model.proto.constant.DeviceType> values) {
        ensureDeviceTypesIsMutable();
     ...
     */
    private void addAllDeviceTypesValue(Iterable<Integer> values) {
        ensureDeviceTypesIsMutable();
    ...
    public static UserOnlineStatus parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UserOnlineStatus, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllDeviceTypesValue(Iterable<Integer> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO: {
                Object[] objects = new Object[]{"userId_",
                        "userStatus_",
                        "deviceTypes_",
                        "customAttributes_",
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UserOnlineStatus> parser =
                        PARSER;
                if (parser == null) {
