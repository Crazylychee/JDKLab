...
public final class QueryRelationshipsRequest extends
    ...
    public static Builder newBuilder(
            QueryRelationshipsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryRelationshipsRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryRelationshipsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryRelationshipsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
