...
public final class PrivateConversation extends
    ...
    public static PrivateConversation parseFrom(
    ...
    public static PrivateConversation parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<PrivateConversation, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case BUILD_MESSAGE_INFO: {
                Object[] objects = new Object[]{"ownerId_",
                        "targetId_",
                        "readDate_",
                        "customAttributes_",
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<PrivateConversation> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (PrivateConversation.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final PrivateConversation DEFAULT_INSTANCE;
    static {
    ...
    public static PrivateConversation getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
