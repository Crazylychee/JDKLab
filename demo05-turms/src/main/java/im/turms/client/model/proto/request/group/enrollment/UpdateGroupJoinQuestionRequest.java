...
public final class UpdateGroupJoinQuestionRequest extends
    ...
    private com.google.protobuf.Internal.ProtobufList<String> answers_;
     ...
     */
    @Override
    public java.util.List<String> getAnswersList() {
        return answers_;
    }
    ...
    private void ensureAnswersIsMutable() {
        com.google.protobuf.Internal.ProtobufList<String> tmp = answers_;
        if (!tmp.isModifiable()) {
     ...
     */
    private void setAnswers(int index, String value) {
        Class<?> valueClass = value.getClass();
     ...
     */
    private void addAnswers(String value) {
        Class<?> valueClass = value.getClass();
        ensureAnswersIsMutable();
        answers_.add(value);
    }
     ...
     */
    private void addAllAnswers(Iterable<String> values) {
        ensureAnswersIsMutable();
    ...
    public static Builder newBuilder(
            UpdateGroupJoinQuestionRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateGroupJoinQuestionRequest, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllAnswers(Iterable<String> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateGroupJoinQuestionRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateGroupJoinQuestionRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
