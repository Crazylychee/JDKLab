...
public final class CreateSessionRequest extends
    ...
    private com.google.protobuf.MapFieldLite<String, String> deviceDetails_ =
            com.google.protobuf.MapFieldLite.emptyMapField();

    private com.google.protobuf.MapFieldLite<String, String> internalGetDeviceDetails() {
        return deviceDetails_;
    }

    private com.google.protobuf.MapFieldLite<String, String> internalGetMutableDeviceDetails() {
    ...
    public boolean containsDeviceDetails(String key) {
    ...
    @Override
    @Deprecated
    public java.util.Map<String, String> getDeviceDetails() {
    ...
    public java.util.Map<String, String> getDeviceDetailsMap() {
    ...
    public /* nullable */
    String getDeviceDetailsOrDefault(
            String key,
            /* nullable */
            String defaultValue) {
        Class<?> keyClass = key.getClass();
        java.util.Map<String, String> map = internalGetDeviceDetails();
    ...
    public String getDeviceDetailsOrThrow(String key) {
        Class<?> keyClass = key.getClass();
        java.util.Map<String, String> map = internalGetDeviceDetails();
     ...
     * <code>map&lt;string, string&gt; device_details = 6;</code>
     */
    private java.util.Map<String, String> getMutableDeviceDetailsMap() {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<CreateSessionRequest, Builder>
            implements
        ...
        public Builder removeDeviceDetails(String key) {
            Class<?> keyClass = key.getClass();
            copyOnWrite();
            instance.getMutableDeviceDetailsMap()
                    .remove(key);
        ...
        String getDeviceDetailsOrDefault(
                ...
                String defaultValue) {
            Class<?> keyClass = key.getClass();
            java.util.Map<String, String> map = instance.getDeviceDetailsMap();
            return map.getOrDefault(key, defaultValue);
        }
         ...
         * <code>map&lt;string, string&gt; device_details = 6;</code>
         */
        public Builder putDeviceDetails(String key, String value) {
            Class<?> keyClass = key.getClass();
            Class<?> valueClass = value.getClass();
            copyOnWrite();
            instance.getMutableDeviceDetailsMap()
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<CreateSessionRequest> parser =
                        PARSER;
                if (parser == null) {
