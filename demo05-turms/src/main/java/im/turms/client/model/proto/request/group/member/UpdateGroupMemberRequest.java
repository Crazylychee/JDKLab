...
public final class UpdateGroupMemberRequest extends
    ...
    public static Builder newBuilder(
            UpdateGroupMemberRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<UpdateGroupMemberRequest, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<UpdateGroupMemberRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (UpdateGroupMemberRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
