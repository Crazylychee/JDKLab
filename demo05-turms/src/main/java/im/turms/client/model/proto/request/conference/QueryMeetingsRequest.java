...
public final class QueryMeetingsRequest extends
     ...
     */
    @Override
    public java.util.List<Long> getIdsList() {
        return ids_;
    }
     ...
     */
    @Override
    public java.util.List<Long> getCreatorIdsList() {
        return creatorIds_;
    }
     ...
     */
    private void addAllCreatorIds(Iterable<? extends Long> values) {
        ensureCreatorIdsIsMutable();
     ...
     */
    @Override
    public java.util.List<Long> getGroupIdsList() {
        return groupIds_;
    }
     ...
     */
    private void addAllGroupIds(Iterable<? extends Long> values) {
        ensureGroupIdsIsMutable();
    ...
    public static QueryMeetingsRequest parseFrom(
    ...
    public static QueryMeetingsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            QueryMeetingsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<QueryMeetingsRequest, Builder>
            implements
         ...
         * @return This builder for chaining.
         */
        public Builder addAllIds(Iterable<? extends Long> values) {
            copyOnWrite();
         ...
         * @return This builder for chaining.
         */
        public Builder addAllCreatorIds(Iterable<? extends Long> values) {
            copyOnWrite();
         ...
         * @return This builder for chaining.
         */
        public Builder addAllGroupIds(Iterable<? extends Long> values) {
            copyOnWrite();
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new QueryMeetingsRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<QueryMeetingsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (QueryMeetingsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final QueryMeetingsRequest DEFAULT_INSTANCE;
    static {
    ...
    public static QueryMeetingsRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
