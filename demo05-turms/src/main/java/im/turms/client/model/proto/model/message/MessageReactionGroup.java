...
public final class MessageReactionGroup extends
    ...
    private void addAllUserInfos(
            Iterable<? extends im.turms.client.model.proto.model.user.UserInfo> values) {
        ensureUserInfosIsMutable();
    ...
    public static MessageReactionGroup parseFrom(
    ...
    public static MessageReactionGroup parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            MessageReactionGroup prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<MessageReactionGroup, Builder>
            implements
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new MessageReactionGroup();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            case BUILD_MESSAGE_INFO: {
                Object[] objects = new Object[]{"reactionType_",
                        "reactionCount_",
                        "userInfos_",
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<MessageReactionGroup> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (MessageReactionGroup.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final MessageReactionGroup DEFAULT_INSTANCE;
    static {
    ...
    public static MessageReactionGroup getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
